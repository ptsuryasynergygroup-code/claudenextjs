...
import type { DepartmentDto, PositionDto } from '@/lib/entities/organization/schema'
...
export function UsersView({
  ...
  userRolesMap: Record<string, { id: string; name: string }[]>
}) {
          ...
          <Table>
            ...
            <TableBody>
              {filteredUsers.map((user) => {
                const department = user.departmentId ? deptById.get(user.departmentId) : null
                const position = user.positionId ? posById.get(user.positionId) : null
